...
namespace Server.Data
{
    ...
    public class SpriteAttackResultData : IProtoBuffData
    {
        ...
        public int fromBytes(byte[] data, int offset, int count)
        {
            ...
            for (; mycount < count; )
            {
                ...
                switch (fieldnumber)
                {
                    ...
                    case 6: this.experience = ProtoUtil.LongMemberFromBytes(data, wt, ref pos, ref mycount); break;
        ...
        public byte[] toBytes()
        {
            ...
            total += ProtoUtil.GetLongSize(experience, true, 6);
            ...
            ProtoUtil.LongMemberToBytes(data, 6, ref offset, experience);
