...
namespace Server.Data
{
    ...
    public class RoleData : ICloneable
    {
        ...
        public RoleData4Selector ExtractRoleData4Selector()
        {
            ...
            roleData4Selector.RoleID = this.RoleID;
            roleData4Selector.RoleName = this.RoleName;
            roleData4Selector.RoleSex = this.RoleSex;
            roleData4Selector.Occupation = this.Occupation;
            roleData4Selector.Level = this.Level;
            roleData4Selector.Faction = this.Faction;
            roleData4Selector.OtherName = this.OtherName;
            roleData4Selector.GoodsDataList = this.GoodsDataList;
            roleData4Selector.MyWingData = this.MyWingData;
