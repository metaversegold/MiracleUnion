...
namespace Server.Data
{
    ...
    public class VerifyPlayerRecallData
    {
        ...
        /// <summary>
        /// 被召回userID、被召回角色ID、被召回server ID、推荐人zoneID + "#" + roleID、角色level、vip等级
        /// </summary>
        [ProtoMember(7)]
        ...
        /// <summary>
        /// 验证类型, 
        /// 类型0 	验证该玩家是否在本期活动中符合召回条件，用来让服务器发送奖品 
        /// 类型1 	验证该玩家和userInputID的绑定关系，用来让服务器给userInputID这个人发奖
        /// </summary>
        [ProtoMember(8)]
