...
{
    [MenuItem("Tools/Terrain/Object to Terrain &q")]
    ...
    static void BeginTransfer()
    {
        ...
        int cHMWidth = terrain_data.heightmapResolution;         // 地形の幅と高さを取得する(この高さは高度のことではない)
        int cHMHeight = terrain_data.heightmapResolution;       // ２次元配列で管理されている Heightmap のサイズ
