...
void main()
{
    ...
    t16_8.xyz = t10_0.xyz * _LightColor0.xyz;
    t16_4.xyz = t10_0.xyz * vs_TEXCOORD3.xyz;
...
void main()
{
    ...
    t10_1.xyz = t10_2.xyz * vec3(2.0, 2.0, 2.0);
    t16_3.xyz = t10_0.xyz * t10_1.xyz;
    SV_Target0.w = t10_0.w;
    SV_Target0.xyz = t16_3.xyz;
    return;
}
...
void main ()
{
  ...
  c_11.w = tmpvar_3.w;
  c_10.w = c_11.w;
  c_10.xyz = (tmpvar_3.xyz * tmpvar_7);
  gl_FragData[0] = c_10;
}
...
void main()
{
    ...
    vec3 txVec0 = vec3(vs_TEXCOORD4.xy,vs_TEXCOORD4.z);
    t16_3.x = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec0, 0.0);
    t16_8.x = (-_LightShadowData.x) + 1.0;
    t16_3.x = t16_3.x * t16_8.x + _LightShadowData.x;
    t10_2.xyz = texture(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    t16_8.xyz = t16_3.xxx * t10_2.xyz;
    t10_1.xyz = t10_2.xyz * vec3(2.0, 2.0, 2.0);
    t16_8.xyz = min(t16_8.xyz, t10_1.xyz);
    t16_4.xyz = t16_3.xxx * t10_1.xyz;
    t16_3.xyz = max(t16_8.xyz, t16_4.xyz);
    t16_3.xyz = t10_0.xyz * t16_3.xyz;
    SV_Target0.w = t10_0.w;
    SV_Target0.xyz = t16_3.xyz;
    return;
...
void main()
{
    ...
    t16_3.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    t16_3.x = max(t16_3.x, 0.0);
    t16_8.xyz = t0.xyz * _LightColor0.xyz;
    t16_4.xyz = t0.xyz * vs_TEXCOORD3.xyz;
    t16_3.xyz = t16_8.xyz * t16_3.xxx + t16_4.xyz;
    t16_2.xyz = t16_3.xyz + (-unity_FogColor.xyz);
    t17 = vs_TEXCOORD5;
    t17 = clamp(t17, 0.0, 1.0);
    t0.xyz = vec3(t17) * t16_2.xyz + unity_FogColor.xyz;
    SV_Target0 = t0;
    return;
}
...
{
    t0 = texture(_MainTex, vs_TEXCOORD0.xy);
    t10_1.x = t0.w + (-_Cutoff);
    tb2 = t10_1.x<0.0;
    if((int(tb2) * int(0xffffffffu))!=0){discard;}
    t10_2.xyz = texture(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    t10_1.xyz = t10_2.xyz * vec3(2.0, 2.0, 2.0);
    t2.xyz = t0.xyz * t10_1.xyz + (-unity_FogColor.xyz);
    t11 = vs_TEXCOORD5;
    t11 = clamp(t11, 0.0, 1.0);
    t0.xyz = vec3(t11) * t2.xyz + unity_FogColor.xyz;
    SV_Target0 = t0;
    return;
}
...
void main()
{
    ...
    t16_4.xyz = t16_3.xxx * t10_1.xyz;
    t16_3.xyz = max(t16_8.xyz, t16_4.xyz);
    t2.xyz = t0.xyz * t16_3.xyz + (-unity_FogColor.xyz);
    t17 = vs_TEXCOORD5;
    t17 = clamp(t17, 0.0, 1.0);
    t0.xyz = vec3(t17) * t2.xyz + unity_FogColor.xyz;
    SV_Target0 = t0;
    return;
}
...
void main()
{
    ...
    t16_3.xyz = log2(t16_3.xyz);
    t2.xyz = (-t16_3.xyz) + vs_TEXCOORD4.xyz;
    t2.xyz = t0.xyz * t2.xyz + (-unity_FogColor.xyz);
    t14 = vs_TEXCOORD5;
    t14 = clamp(t14, 0.0, 1.0);
    t0.xyz = vec3(t14) * t2.xyz + unity_FogColor.xyz;
    SV_Target0 = t0;
    return;
}
...
void main ()
{
  ...
  emission_7.xyz = (emission_7.xyz + (tmpvar_3.xyz * xlv_TEXCOORD4));
...
void main ()
{
  ...
  emission_10.xyz = (emission_10.xyz + (tmpvar_4.xyz * tmpvar_7));
...
void main ()
{
  ...
  emission_6 = tmpvar_9;
  emission_6.xyz = (emission_6.xyz + (tmpvar_2.xyz * xlv_TEXCOORD4));
...
void main()
{
    ...
    SV_Target0.xyz = t10_0.xyz;
    SV_Target3.xyz = t10_0.xyz * vs_TEXCOORD4.xyz;
    SV_Target0.w = 1.0;
    SV_Target1 = vec4(0.0, 0.0, 0.0, 0.0);
    t10_1.xyz = vs_TEXCOORD1.xyz * vec3(0.5, 0.5, 0.5) + vec3(0.5, 0.5, 0.5);
    SV_Target2.xyz = t10_1.xyz;
...
void main()
{
    ...
    t10_2.xyz = texture(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    t10_1.xyz = t10_2.xyz * vec3(2.0, 2.0, 2.0);
    SV_Target3.xyz = t10_0.xyz * t10_1.xyz;
    SV_Target3.w = 1.0;
    return;
}
