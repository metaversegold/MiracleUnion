...
void main ()
{
  ...
  lowp vec3 normalV_2;
  lowp vec4 baseColor_3;
  lowp vec4 tmpvar_4;
  tmpvar_4 = (texture2D (_MainTex, xlv_TEXCOORD0) * _Color);
  baseColor_3.w = tmpvar_4.w;
  baseColor_3.xyz = (tmpvar_4.xyz + (textureCube (_Cube, xlv_TEXCOORD1).xyz * _ReflectColor.xyz));
  mediump vec3 tmpvar_5;
  tmpvar_5 = normalize(xlv_TEXCOORD2);
  normalV_2 = tmpvar_5;
  highp vec2 tmpvar_6;
  tmpvar_6.y = 0.0;
  tmpvar_6.x = (_Time.x * _TimeScale2);
  lowp float tmpvar_7;
  tmpvar_7 = dot (normalize((
    (texture2D (_ViewDirTex2, tmpvar_6).xyz * 2.0)
   - 1.0)), normalV_2);
  mediump float tmpvar_8;
  tmpvar_8 = max (0.0, ((
    (tmpvar_7 * _LightScale)
   - _LightScale) + 1.0));
  specPow_1 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9.xyz = (baseColor_3 + (_SpecColor2 * specPow_1)).xyz;
  tmpvar_9.w = baseColor_3.w;
...
void main()
{
    t0.x = _Time.x * _TimeScale2;
    t0.y = 0.0;
    t10_0.xyz = texture(_ViewDirTex2, t0.xy).xyz;
    t16_0.xyz = t10_0.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    t10_1.x = dot(t16_0.xyz, t16_0.xyz);
    t10_1.x = inversesqrt(t10_1.x);
    t10_1.xyz = t16_0.xyz * t10_1.xxx;
    t16_2.x = dot(vs_TEXCOORD2.xyz, vs_TEXCOORD2.xyz);
    t16_2.x = inversesqrt(t16_2.x);
    t16_2.xyz = t16_2.xxx * vs_TEXCOORD2.xyz;
    t10_1.x = dot(t10_1.xyz, t16_2.xyz);
    t16_2.x = t10_1.x * _LightScale + (-_LightScale);
    t16_2.x = t16_2.x + 1.0;
    t16_2.x = max(t16_2.x, 0.0);
    t10_0.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    t10_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    t16_1 = t10_1 * _Color;
    t10_3.xyz = t10_0.xyz * _ReflectColor.xyz + t16_1.xyz;
    SV_Target0.w = t16_1.w;
    SV_Target0.xyz = _SpecColor2.xyz * t16_2.xxx + t10_3.xyz;
    return;
}
