...
void main ()
{
  ...
  tmpvar_11 = clamp (dot (normalize(
    (((v_7.xyz * _glesNormal.x) + (v_8.xyz * _glesNormal.y)) + (v_9.xyz * _glesNormal.z))
  ), _WorldSpaceLightPos0.xyz), 0.0, 1.0);
  tmpvar_10 = tmpvar_11;
...
{
  mediump vec4 c_1;
  mediump vec4 weights_2;
  mediump vec3 splat3_3;
  mediump vec3 splat2_4;
  mediump vec3 splat1_5;
  mediump vec3 splat0_6;
  lowp vec3 tmpvar_7;
  tmpvar_7 = texture2D (_Splat0, xlv_TEXCOORD0.xy).xyz;
  splat0_6 = tmpvar_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = texture2D (_Splat1, xlv_TEXCOORD0.zw).xyz;
  splat1_5 = tmpvar_8;
  lowp vec3 tmpvar_9;
  tmpvar_9 = texture2D (_Splat2, xlv_TEXCOORD0_1.xy).xyz;
  splat2_4 = tmpvar_9;
  lowp vec3 tmpvar_10;
  tmpvar_10 = texture2D (_Splat3, xlv_TEXCOORD0_1.zw).xyz;
  splat3_3 = tmpvar_10;
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture2D (_Control, xlv_TEXCOORD0_2.xy);
  weights_2 = tmpvar_11;
  mediump vec4 tmpvar_12;
  tmpvar_12.w = 1.0;
  tmpvar_12.xyz = (((
    ((weights_2.x * splat0_6) + (weights_2.y * splat1_5))
   + 
    (weights_2.z * splat2_4)
  ) + (weights_2.w * splat3_3)) * ((_LightColor0.xyz * xlv_TEXCOORD4.w) + (glstate_lightmodel_ambient * 2.0).xyz));
  c_1.w = tmpvar_12.w;
  highp float tmpvar_13;
  tmpvar_13 = clamp (xlv_TEXCOORD3, 0.0, 1.0);
  c_1.xyz = mix (unity_FogColor.xyz, tmpvar_12.xyz, vec3(tmpvar_13));
  gl_FragData[0] = c_1;
}
...
void main()
{
    ...
    gl_Position = t0;
    vs_TEXCOORD3 = t0.z * unity_FogParams.z + unity_FogParams.w;
    t0.xy = in_TEXCOORD0.xy * _Splat0_ST.xy + _Splat0_ST.zw;
    t0.zw = in_TEXCOORD0.xy * _Splat1_ST.xy + _Splat1_ST.zw;
    vs_TEXCOORD0 = t0;
    t0.xy = in_TEXCOORD0.xy * _Splat2_ST.xy + _Splat2_ST.zw;
...
void main()
{
    ...
    t10_5.xyz = glstate_lightmodel_ambient.xyz * vec3(2.0, 2.0, 2.0);
    t16_6.xyz = _LightColor0.xyz * vs_TEXCOORD4.www + t10_5.xyz;
    t16_0.xyz = t16_4.xyz * t16_6.xyz + (-unity_FogColor.xyz);
    t21 = vs_TEXCOORD3;
...
void main ()
{
  ...
  tmpvar_14.xyz = (((
   ...
   + 
    (weights_2.z * splat2_4)
  ) + (weights_2.w * splat3_3)) * ((_LightColor0.xyz * xlv_TEXCOORD4.w) + tmpvar_13));
  c_1.w = tmpvar_14.w;
  highp float tmpvar_15;
  tmpvar_15 = clamp (xlv_TEXCOORD3, 0.0, 1.0);
  c_1.xyz = mix (unity_FogColor.xyz, tmpvar_14.xyz, vec3(tmpvar_15));
  gl_FragData[0] = c_1;
}
