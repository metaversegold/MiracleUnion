...
void main ()
{
  ...
  tmpvar_12 = (unity_FogParams.x * tmpvar_1.z);
  gl_Position = tmpvar_1;
  xlv_TEXCOORD0 = tmpvar_2;
  xlv_TEXCOORD0_1 = tmpvar_3;
  xlv_TEXCOORD0_2 = tmpvar_4;
  xlv_TEXCOORD3 = exp2((-(tmpvar_12) * tmpvar_12));
...
void main ()
{
  ...
  lowp vec3 tmpvar_6;
  tmpvar_6 = texture2D (_Layer1, xlv_TEXCOORD0.xy).xyz;
  splat0_5 = tmpvar_6;
  lowp vec3 tmpvar_7;
  tmpvar_7 = texture2D (_Layer2, xlv_TEXCOORD0.zw).xyz;
  splat1_4 = tmpvar_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = texture2D (_Layer3, xlv_TEXCOORD0_1.xy).xyz;
  splat2_3 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9 = texture2D (_MainTex, xlv_TEXCOORD0_2.xy);
  weights_2 = tmpvar_9;
  mediump vec4 tmpvar_10;
  tmpvar_10.w = 1.0;
  tmpvar_10.xyz = (((
    (weights_2.x * splat0_5)
   + 
    (weights_2.y * splat1_4)
  ) + (weights_2.z * splat2_3)) * ((_LightColor0.xyz * xlv_TEXCOORD4.w) + (glstate_lightmodel_ambient * 2.0).xyz));
  c_1.w = tmpvar_10.w;
  highp float tmpvar_11;
...
void main()
{
    ...
    t10_4.xyz = glstate_lightmodel_ambient.xyz * vec3(2.0, 2.0, 2.0);
    t16_5.xyz = _LightColor0.xyz * vs_TEXCOORD4.www + t10_4.xyz;
    t16_0.xyz = t16_3.xyz * t16_5.xyz + (-unity_FogColor.xyz);
    t18 = vs_TEXCOORD3;
...
void main ()
{
  ...
  tmpvar_12.xyz = (((
   ...
   + 
    (weights_2.y * splat1_4)
  ) + (weights_2.z * splat2_3)) * ((_LightColor0.xyz * xlv_TEXCOORD4.w) + tmpvar_11));
  c_1.w = tmpvar_12.w;
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "SHADOWS_NATIVE" "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_EXP2" }
"!!GLES
#version 100
